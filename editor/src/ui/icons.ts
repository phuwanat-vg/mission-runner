/**
 * Inline SVG icons (Lucide-style 24x24 stroke paths). Inline so the bundle
 * works offline on the robot and icons inherit the text color.
 */
...
const PATHS = {
  ...
  eye: '<path d="M2.06 12.35a1 1 0 0 1 0-.7C3.42 8.36 7.24 5 12 5s8.58 3.36 9.94 6.65a1 1 0 0 1 0 .7C20.58 15.64 16.76 19 12 19s-8.58-3.36-9.94-6.65Z"/><circle cx="12" cy="12" r="3"/>',
  eyeOff: '<path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c4.76 0 8.58 3.36 9.94 6.65a1 1 0 0 1 0 .7 10.52 10.52 0 0 1-2.4 3.44"/><path d="M14.12 14.12a3 3 0 1 1-4.24-4.24"/><path d="m2 2 20 20"/><path d="M6.61 6.61A13.5 13.5 0 0 0 2.06 11.65a1 1 0 0 0 0 .7C3.42 15.64 7.24 19 12 19a10.4 10.4 0 0 0 4.4-.96"/>',
  ...
  anchorOff: '<path d="M12 22V8"/><path d="M5 12H2a10 10 0 0 0 20 0h-3"/><circle cx="12" cy="5" r="3"/><path d="m3 3 18 18"/>',
  ...
  circuit: '<path d="M12 2v6"/><circle cx="12" cy="11" r="3"/><path d="M12 14v8"/><path d="M4 7h4"/><path d="M16 7h4"/><path d="M4 17h4"/><path name="r" d="M16 17h4"/>',
  ...
  // map view
  mousePointer: '<path d="M4.037 4.688a.5.5 0 0 1 .65-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5 0 0 1-.947.063z"/>',
  mapPinOff: '<path d="M12.75 7.09a3 3 0 0 1 2.16 2.16"/><path d="M17.072 17.072c-1.634 2.17-3.527 3.912-4.471 4.727a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 1.432-4.568"/><path d="m2 2 20 20"/><path d="M8.475 2.818A8 8 0 0 1 20 10a7.2 7.2 0 0 1-.393 2.372"/><path d="M9.13 9.13a3 3 0 0 0 3.74 3.74"/>',
  ...
  zone: '<path d="M3 8.5 9.5 3l11 4.5-3 9.5-9 4z"/><circle cx="3" cy="8.5" r="1.6"/><circle cx="9.5" cy="3" r="1.6"/><circle cx="20.5" cy="7.5" r="1.6"/><circle cx="17.5" cy="17" r="1.6"/><circle cx="8.5" cy="21" r="1.6"/>',
  route2: '<path d="M4 20 8 8l5 7 3-9 4 14"/>',
  gauge: '<path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/>',
  rewind: '<path d="M11 19 2 12l9-7z"/><path d="M22 19l-9-7 9-7z"/>',
  ghost: '<path d="M9 10h.01"/><path d="M15 10h.01"/><path d="M12 2a8 8 0 0 0-8 8v12l3-3 2.5 3 2.5-3 2.5 3 2.5-3 3 3V10a8 8 0 0 0-8-8"/>',
